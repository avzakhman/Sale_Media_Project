                ...
                <div class="swiper-slide">
                    <div class="container">
                        <div class="slide-container">
                            <h1>Создаем cайты,<br>приносящие <span>прибыль</span></h1>
                            <ul>
                                <li>Проанализируем потребности вашей <span>целевой аудитории</span></li>
                                <li>Изучим <span> предложения </span>ваших конкурентов</li>
                                <li>Учтём особенности построения <span>бизнес-процессов</span> вашей компании</li>
                            </ul>
        ...
        <section class="contents contents__bg">
            <div class="container">
                <article class="extras">
                    <h2>Крутой цепляющий заголовок</h2>
                    <div class="extras__scroll">
                        <div class="extras__wrapper">
                            <div class="extra-block">
                                <h3>Надежность</h3>
                                <p>Занимаемся созданием сайтов более 12 лет. Являемся «золотыми партнерами» 1СБитрикс и участниками программы мониторинга качества внедрений.</p>
                            </div>
                            <div class="extra-block">
                                <h3>Удобство</h3>
                                <p>Не тратим ваше время на бесконечные обсуждения. Быстро вникаем в суть проекта и предлагаем оптимальные решение. На связи 24/7.</p>
                            </div>
                            <div class="extra-block">
                                <h3>ПРОЗРАЧНОСТЬ</h3>
                                <p>Показываем, из каких элементов складывается стоимость сайта, а также на каком этапе разработки находимся.</p>
                            </div>
                            <div class="extra-block">
                                <h3>Безопасность</h3>
                                <p>В договоре четко прописываем все этапы работ над сайтом, их стоимость и сроки выполнения.</p>
                            </div>
                        </div>
                    </div>
                </article>
                <article class="services">
                    ...
                    <div class="all-services">
                        <h3>Заголовок про <span> кучу сервисов</span></h3>
                        ...
                        <button class="button contactModalTrigger">все услуги</button>
                    </div>
                </article>
                <article class="facts">
                    <h2>факты</h2>
                    <div class="facts__wrapper">
                        <div class="fact-block">
                            <p><span>27</span><br>Cертифицированных сотрудников Битрикс</p>
                        </div>
                        <div class="fact-block">
                            <p><span>250+</span><br>Cертифицированных сотрудников Битрикс</p>
                        </div>
                        <div class="fact-block">
                            <p><span>140+</span><br>Cертифицированных сотрудников Битрикс</p>
                        </div>
                        <div class="fact-block">
                            <p><span>50</span><br>Cертифицированных сотрудников Битрикс</p>
                        </div>
                    </div>
                </article>
            </div>
            <article class="advantages">
                <div class="container">
                    <h2>преимущества</h2>
                    <div class="advantages__scroll">
                        <div class="advantages__wrapper">
                            <div class="advantage-block">
                                <h3>Опыт создания сайтов разных форматов</h3>
                                <p>Среди наших проектов - интернет-магазины, интернет-порталы, корпоративные IT системы, мобильные приложения</p>
                            </div>
                            <div class="advantage-block">
                                <h3>Начинаем разработку коммерческих проектов с маркетингового анализа</h3>
                                <p>Анализируем потребности вашей «Целевой Аудитории» и ваших конкурентов, чтобы создать максимально выгодное предложение для ваших потенциальных клиентов</p>
                            </div>
                            <div class="advantage-block">
                                <h3>Опыт работы над сложными проектами</h3>
                                <p>Разрабатываем оригинальные решения для реализации нестандартных задач клиента</p>
                            </div>
                            <div class="advantage-block">
                                <h3>Работаем с учетом бизнес-процессов</h3>
                                <p>При разработке сайтов по продаже услуг или сложной продукции (например, промышленное производство) учитываем особенности построения бизнес-процессов компании, что увеличивает приток заказов онлайн</p>
                            </div>
                            <div class="advantage-block">
                                <h3>Проект от начала до его сдачи ведет персональный менеджер</h3>
                                <p>Менеджер проекта вникнет в суть вашей задачи, подберет оптимальное по цене и качеству решение, оперативно решит все возникающие в процессе работы вопросы</p>
                            </div>
                            <div class="advantage-block">
                                <h3>Реанимируем проекты на любой стадии</h3>
        ...
        <section class="contents__no-bg">
            <div class="container">
                ...
                <article class="portfolio">
                    ...
                    <div class="all-services all-services__portfolio">
                        <h3>Заголовок про <span> запрос портфолио</span></h3>
                        <p><span>Но мы знаем, что раз вы здесь, то вам уже нужен сайт. </span> Поэтому не теряйте время!<br> Пока вы раздумываете, ваши клиенты уходят к конкурентам.</p>
                        <button class="button button__order portfolioModalTrigger">запросить портфолио</button>
                    </div>
                </article>
                <article class="order">
                ...
                <article class="get">
                    <h2>что получите</h2>
                    <div class="get__scroll">
                        <div class="get__wrapper">
                            <div class="get-block">
                                <h3>Вы не будете терять клиентов</h3>
                                <p>Дизайн сайта последовательно подталкивает пользователя к <span> совершению целевого действия </span>– положить товар в корзину, отправить заявку, запросить прайс-лист, оставить контакт для связи т.д. </p>
                                <p>Это увеличивает конверсию сайта, <span>минимизирует</span> расходы на привлечение клиентов, способствует быстрой окупаемости рекламных компаний</p>
                            </div>
                            <div class="get-block">
                                <h3>Вам не придется платить за доработки </h3>
                                <p>Доработки вам не потребуются, т.к. вы получаете полностью готовый к работе сайт.</p>
                                <p><span>Мы изготовим сайт «под ключ» </span>, в том числе наполним его оригинальными текстами, написанными профессиональным копирайтером с учетом поисковых запросов.</p>
                                <p>Интегрируем платежные системы, подключим онлайн-кассы, CRM</p>
           
                            </div>
                            <div class="get-block">
                                <h3>Вы получаете оптимальное по цене и качеству решение</h3>
                                <p>Стоимость сайта включает работу команды квалифицированных профессионалов: маркетолога, копирайтера, дизайнера, верстальщика, программиста, руководителя проекта. </p>
            ...
            <div class="container">
                <div class="cities__wrapper">
                    <div class="cities__menu">
                        <button class="cities__menu_active">Москва</button>
                        <button>Рига</button>
                    </div>
                    <article class="city-block">
                        ...
                        <address>
                            ...
                            <div>
                                <h3>Телефон</h3>
                                <a href="tel:'84956253581'">8 495 625 35 81</a><br>
                                <a href="tel:'88002002316'">8 800 200 23 16</a>
                            </div>
                            <div>
                                <h3>Электронная почта</h3>
                                <a href="mailto:info@salemedia.org">info@salemedia.org</a>
                            </div>
                        </address>
                    </article>
                    <article class="city-block city-block__hidden">
                        <h2>Рига</h2>
                        <hr>
                        <address>
                            <div>
                            ...
                            <div>
                                <h3>Телефон</h3>
                                <a href="tel:'84956003589'">8 495 600 35 89</a><br>
                                <a href="tel:'88002000017'">8 800 200 00 17</a>
                            </div>
                            <div>
                                <h3>Электронная почта</h3>
                                <a href="mailto:info@salemedia.org">info@salemedia.org</a>
